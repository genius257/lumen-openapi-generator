...
class Class_ extends BaseTag implements StaticMethod, JsonSerializable
{
    ...
    public static function create($body, DescriptionFactory $descriptionFactory = null, Context $context = null): Class_
    {
