...
class Tag extends BaseTag implements StaticMethod, JsonSerializable
{
    protected $name = "tag";
    ...
    public static function create($body, DescriptionFactory $descriptionFactory = null, Context $context = null): Tag
    {
